...
"""
Tests multiiple arenas are merged correctly and that the behaviour is correct.
"""
...
def test_should_merge_if_merge_flag_included():
    run_behaviour_in_aai(
        os.path.join(".", "testConfigs", "testMergedArenas.yml"),
        1.6,
...
def test_should_skip_next_merged_arena_if_fails_from_lava():
    run_behaviour_in_aai(
        os.path.join(".", "testConfigs", "testFailArenas.yml"),
        0.895,
